...
from src.errors.error_handlers import ModelInitializationError, APIKeyError, handle_vendor_exception
from src.enums.model_vendors import MODEL_VENDORS, VendorLookup
# Configure logging
...
class ModelFactory:
    ...
    def _create_model_class(self, vendor: Enum, model_id: str, settings: Dict[str, Any]) -> Any:
        ...
        model_config = {
            ...
            vendor.RequestTimeoutKey.value: settings.get("timeout", settings.get("request_timeout", 300))
        }
        # Create model
